package com.datacenter.asset.infrastructure.adapters.in.rest.controllers.fielddefinition;
...
import com.datacenter.asset.infrastructure.adapters.in.rest.dto.request.fielddefinition.CreateFieldGroupRequest;
import com.datacenter.asset.infrastructure.adapters.in.rest.dto.request.fielddefinition.UpdateFieldGroupRequest;
import com.datacenter.asset.infrastructure.adapters.in.rest.dto.response.fielddefinition.FieldGroupResponse;
import com.datacenter.asset.infrastructure.adapters.in.rest.mappers.fielddefinition.FieldGroupRestMapper;
...
public class FieldGroupController {
    ...
    public ResponseEntity<FieldGroupResponse> update(@PathVariable UUID id, @Valid @RequestBody UpdateFieldGroupRequest request) {
        FieldGroup updated = fieldGroupUseCase.update(id, request.getName(), request.getDisplayOrder(), request.getSubAssetTypeId()); // assuming description doesn't exist on update or requires passing
