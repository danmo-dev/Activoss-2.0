import { $n as Output, Dl as ɵɵdefineInjector, Do as ɵɵgetCurrentView, Dr as ViewEncapsulation, Ea as ɵɵcontentQuery, Fc as NgZone, Fl as ɵɵresetView, Hs as ɵɵtemplate, Il as ɵɵrestoreView, In as Input, Lc as PLATFORM_ID, Pn as Inject, S as ViewChild, Us as ɵɵtemplateRefExtractor, Wi as setClassMetadata, Xo as ɵɵloadQuery, Yo as ɵɵlistener, Zo as ɵɵnextContext, _o as ɵɵelementContainer, a as ContentChildren, an as ChangeDetectionStrategy, as as ɵɵprojectionDef, ba as ɵɵclassMap, bc as EventEmitter, bo as ɵɵelementEnd, bs as ɵɵreference, cn as Component, cs as ɵɵpureFunction1, da as ɵɵadvance, go as ɵɵelement, ir as Renderer2, is as ɵɵprojection, la as ɵɵNgOnChangesFeature, ls as ɵɵpureFunction2, mc as DOCUMENT, oo as ɵɵdirectiveInject, os as ɵɵproperty, qn as NgModule, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, sc as ɵɵviewQuery, ss as ɵɵpureFunction0, to as ɵɵdefineComponent, us as ɵɵpureFunction3, vo as ɵɵelementContainerEnd, vs as ɵɵqueryRefresh, xo as ɵɵelementStart, ya as ɵɵattribute, yo as ɵɵelementContainerStart } from "./core-CK5_Em9Y.js";
import { C as CommonModule, L as NgClass, V as NgIf, Z as NgTemplateOutlet, q as NgStyle, u as isPlatformBrowser, z as NgForOf } from "./common-CVhezUSH.js";
import { n as DomHandler } from "./primeng-dom-QnWno1CE.js";
import { m as SharedModule, p as PrimeTemplate } from "./primeng-api-hFM0rYSV.js";
import { t as SpinnerIcon } from "./primeng-icons-spinner-eGIdVxq2.js";
//#region node_modules/primeng/fesm2022/primeng-scroller.mjs
/**
...
var _c5 = (a0) => ({ "p-scroller-loading": a0 });
var _c6 = (a0) => ({ "p-component-overlay": a0 });
var _c7 = (a0) => ({ numCols: a0 });
var _c8 = (a0) => ({ options: a0 });
var _c9 = () => ({ styleClass: "p-scroller-loading-icon" });
var _c10 = (a0, a1) => ({
	rows: a0,
	columns: a1
});
...
function Scroller_ng_container_0_div_6_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "div", 13);
	if (rf & 2) {
		ɵɵproperty("ngStyle", ɵɵnextContext(2).spacerStyle);
...
function Scroller_ng_container_0_div_7_ng_template_2_ng_template_1_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "SpinnerIcon", 16);
	if (rf & 2) {
...
function Scroller_ng_container_0_div_7_ng_template_2_Template(rf, ctx) {
	if (rf & 1) ɵɵtemplate(0, Scroller_ng_container_0_div_7_ng_template_2_ng_container_0_Template, 2, 5, "ng-container", 6)(1, Scroller_ng_container_0_div_7_ng_template_2_ng_template_1_Template, 1, 2, "ng-template", null, 5, ɵɵtemplateRefExtractor);
	if (rf & 2) {
		const buildInLoaderIcon_r6 = ɵɵreference(2);
		ɵɵproperty("ngIf", ɵɵnextContext(3).loaderIconTemplate)("ngIfElse", buildInLoaderIcon_r6);
	}
}
...
function Scroller_ng_container_0_Template(rf, ctx) {
	if (rf & 1) {
		...
		ɵɵlistener("scroll", function Scroller_ng_container_0_Template_div_scroll_1_listener($event) {
			ɵɵrestoreView(_r1);
			return ɵɵresetView(ɵɵnextContext().onContainerScroll($event));
		});
...
var Scroller = class Scroller {
	...
	*/
	...
	get loadedItems() {
		if (this._items && !this.d_loading) if (this.both) return this._items.slice(this._appendOnly ? 0 : this.first.rows, this.last.rows).map((item) => this._columns ? item : item.slice(this._appendOnly ? 0 : this.first.cols, this.last.cols));
	...
	get loadedColumns() {
		if (this._columns && (this.both || this.horizontal)) return this.d_loading && this._loaderDisabled ? this.both ? this.loaderArr[0] : this.loaderArr : this._columns.slice(this.both ? this.first.cols : this.first, this.both ? this.last.cols : this.last);
		return this._columns;
	}
	...
	ngOnChanges(simpleChanges) {
		...
		if (simpleChanges.orientation) this.lastScrollPos = this.both ? {
			top: 0,
			left: 0
		} : 0;
		if (simpleChanges.numToleratedItems) {
			const { previousValue, currentValue } = simpleChanges.numToleratedItems;
			if (previousValue !== currentValue && currentValue !== this.d_numToleratedItems) this.d_numToleratedItems = currentValue;
		}
		if (simpleChanges.options) {
			...
			if (previousValue?.numToleratedItems !== currentValue?.numToleratedItems && currentValue?.numToleratedItems !== this.d_numToleratedItems) this.d_numToleratedItems = currentValue.numToleratedItems;
		}
		if (this.initialized) {
			if (!isLoadingChanged && (simpleChanges.items?.previousValue?.length !== simpleChanges.items?.currentValue?.length || simpleChanges.itemSize || simpleChanges.scrollHeight || simpleChanges.scrollWidth)) {
				this.init();
	...
	calculateOptions() {
		...
		if (this.showLoader) this.loaderArr = this.both ? Array.from({ length: numItemsInViewport.rows }).map(() => Array.from({ length: numItemsInViewport.cols })) : Array.from({ length: numItemsInViewport });
	...
	setSpacerSize() {
		if (this._items) {
			...
			} else this.horizontal ? setProp("width", this._columns?.length || this._items.length, this._itemSize) : setProp("height", numItems, this._itemSize);
		}
	}
	...
	onScrollChange(event) {
		...
		if (isRangeChanged) {
			...
			if (this._lazy && this.isPageChanged(first)) {
				...
				(this.lazyLoadState.first !== lazyLoadState.first || this.lazyLoadState.last !== lazyLoadState.last) && this.handleEvents("onLazyLoad", lazyLoadState);
	...
	onContainerScroll(event) {
		...
		} else !this.d_loading && this.onScrollChange(event);
	}
	...
	onResize() {
		...
		this.resizeTimeout = setTimeout(() => {
			if (DomHandler.isVisible(this.elementViewChild?.nativeElement)) {
				...
				(this.both ? isDiffWidth || isDiffHeight : this.horizontal ? isDiffWidth : this.vertical && isDiffHeight) && this.zone.run(() => {
					this.d_numToleratedItems = this._numToleratedItems;
					this.init();
					this.calculateAutoSize();
				});
	...
	static ɵfac = function Scroller_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Scroller)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgZone));
	};
...
(() => {
    ...
    `,
			...
			host: { class: "p-scroller-viewport p-element" },
			styles: ["@layer primeng{p-scroller{flex:1;outline:0 none}.p-scroller{position:relative;overflow:auto;contain:strict;transform:translateZ(0);will-change:scroll-position;outline:0 none}.p-scroller-content{position:absolute;top:0;left:0;min-height:100%;min-width:100%;will-change:transform}.p-scroller-spacer{position:absolute;top:0;left:0;height:1px;width:1px;transform-origin:0 0;pointer-events:none}.p-scroller-loader{position:sticky;top:0;left:0;width:100%;height:100%}.p-scroller-loader.p-component-overlay{display:flex;align-items:center;justify-content:center}.p-scroller-loading-icon{scale:2}.p-scroller-inline .p-scroller-content{position:static}}\n"]
		}]
	}], () => [
		{
		...
		step: [{ type: Input }],
		delay: [{ type: Input }],
		resizeDelay: [{ type: Input }],
		appendOnly: [{ type: Input }],
		inline: [{ type: Input }],
		lazy: [{ type: Input }],
		disabled: [{ type: Input }],
		loaderDisabled: [{ type: Input }],
		columns: [{ type: Input }],
		showSpacer: [{ type: Input }],
		showLoader: [{ type: Input }],
		numToleratedItems: [{ type: Input }],
		loading: [{ type: Input }],
		autoSize: [{ type: Input }],
		trackBy: [{ type: Input }],
		options: [{ type: Input }],
		...
		onScrollIndexChange: [{ type: Output }],
		elementViewChild: [{
			type: ViewChild,
			args: ["element"]
		}],
...
var ScrollerModule = class ScrollerModule {
