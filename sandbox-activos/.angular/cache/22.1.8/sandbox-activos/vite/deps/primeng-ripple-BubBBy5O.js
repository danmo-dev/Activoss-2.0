import { Dl as ɵɵdefineInjector, En as ElementRef, Fc as NgZone, Lc as PLATFORM_ID, Pn as Inject, Qn as Optional, Wi as setClassMetadata, ir as Renderer2, mc as DOCUMENT, no as ɵɵdefineDirective, oo as ɵɵdirectiveInject, qn as NgModule, ro as ɵɵdefineNgModule, wn as Directive } from "./core-CK5_Em9Y.js";
import { u as isPlatformBrowser } from "./common-CVhezUSH.js";
...
var Ripple = class Ripple {
	...
	ngAfterViewInit() {
		if (isPlatformBrowser(this.platformId)) {
			if (this.config && this.config.ripple) this.zone.runOutsideAngular(() => {
				this.create();
	...
	onMouseDown(event) {
		...
		this.timeout = setTimeout(() => {
			let ink = this.getInk();
			if (ink) DomHandler.removeClass(ink, "p-ink-active");
		}, 401);
	}
	getInk() {
	...
	static ɵfac = function Ripple_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Ripple)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(PrimeNGConfig, 8));
	};
...
//#endregion
export { RippleModule as n, Ripple as t };
