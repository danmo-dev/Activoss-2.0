import { $n as Output, Dl as ɵɵdefineInjector, Do as ɵɵgetCurrentView, Dr as ViewEncapsulation, Ea as ɵɵcontentQuery, En as ElementRef, Fc as NgZone, Fl as ɵɵresetView, Hs as ɵɵtemplate, Il as ɵɵrestoreView, In as Input, Lc as PLATFORM_ID, Pn as Inject, S as ViewChild, Wi as setClassMetadata, Xo as ɵɵloadQuery, Yo as ɵɵlistener, Zo as ɵɵnextContext, _o as ɵɵelementContainer, a as ContentChildren, an as ChangeDetectionStrategy, as as ɵɵprojectionDef, ba as ɵɵclassMap, bc as EventEmitter, bo as ɵɵelementEnd, cn as Component, cs as ɵɵpureFunction1, da as ɵɵadvance, gs as ɵɵpureFunctionV, ir as Renderer2, is as ɵɵprojection, mc as DOCUMENT, oo as ɵɵdirectiveInject, os as ɵɵproperty, qn as NgModule, r as ChangeDetectorRef, rl as forwardRef, ro as ɵɵdefineNgModule, sc as ɵɵviewQuery, to as ɵɵdefineComponent, ua as ɵɵProvidersFeature, us as ɵɵpureFunction3, vs as ɵɵqueryRefresh, xo as ɵɵelementStart } from "./core-CK5_Em9Y.js";
...
import { _ as ObjectUtils, f as PrimeNGConfig, m as SharedModule, p as PrimeTemplate, u as OverlayService, y as zindexutils } from "./primeng-api-hFM0rYSV.js";
...
//#region node_modules/primeng/fesm2022/primeng-overlay.mjs
var _c0 = ["overlay"];
var _c1 = ["content"];
var _c2 = ["*"];
...
function Overlay_div_0_div_2_Template(rf, ctx) {
	if (rf & 1) {
		...
		ɵɵlistener("click", function Overlay_div_0_div_2_Template_div_click_0_listener($event) {
			ɵɵrestoreView(_r3);
			return ɵɵresetView(ɵɵnextContext(2).onOverlayContentClick($event));
			...
			ɵɵrestoreView(_r3);
			return ɵɵresetView(ɵɵnextContext(2).onOverlayContentAnimationStart($event));
			...
			ɵɵrestoreView(_r3);
			return ɵɵresetView(ɵɵnextContext(2).onOverlayContentAnimationDone($event));
		});
		ɵɵprojection(2);
...
function Overlay_div_0_Template(rf, ctx) {
	if (rf & 1) {
		...
		ɵɵlistener("click", function Overlay_div_0_Template_div_click_0_listener() {
			ɵɵrestoreView(_r1);
			return ɵɵresetView(ɵɵnextContext().onOverlayClick());
		});
	...
	if (rf & 2) {
		...
		ɵɵproperty("ngStyle", ctx_r1.style)("ngClass", ɵɵpureFunctionV(5, _c3, [
			ctx_r1.modal,
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "center",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "top",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "top-start",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "top-end",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "bottom",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "bottom-start",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "bottom-end",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "left",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "left-start",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "left-end",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "right",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "right-start",
			ctx_r1.modal && ctx_r1.overlayResponsiveDirection === "right-end"
		]));
		ɵɵadvance(2);
...
var Overlay = class Overlay {
	...
	*/
	...
	get modal() {
		if (isPlatformBrowser(this.platformId)) return this.mode === "modal" || this.overlayResponsiveOptions && this.window?.matchMedia(this.overlayResponsiveOptions.media?.replace("@media", "") || `(max-width: ${this.overlayResponsiveOptions.breakpoint})`).matches;
	}
	get overlayMode() {
	...
	onOverlayContentAnimationDone(event) {
		...
		switch (event.toState) {
			case "visible":
				if (this.visible) this.show(container, true);
				this.bindListeners();
				break;
			case "void": if (!this.visible) {
	...
	bindDocumentResizeListener() {
		if (!this.documentResizeListener) this.documentResizeListener = this.renderer.listen(this.window, "resize", (event) => {
			...
			}) : !DomHandler.isTouchDevice()) && this.hide(event, true);
		});
	}
		...
		this.zone.runOutsideAngular(() => {
			this.documentKeyboardListener = this.renderer.listen(this.window, "keydown", (event) => {
				...
				if (this.listener ? this.listener(event, {
					...
					mode: this.overlayMode,
					valid: !DomHandler.isTouchDevice()
				}) : !DomHandler.isTouchDevice()) this.zone.run(() => {
					this.hide(event, true);
				});
			});
		});
	...
	static ɵfac = function Overlay_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Overlay)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(PrimeNGConfig), ɵɵdirectiveInject(OverlayService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgZone));
	};
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		template: function Overlay_Template(rf, ctx) {
			...
			if (rf & 2) ɵɵproperty("ngIf", ctx.modalVisible);
		},
		dependencies: [
			NgClass,
			NgIf,
		...
		encapsulation: 2,
		data: { animation: [trigger("overlayContentAnimation", [transition(":enter", [useAnimation(showOverlayContentAnimation)]), transition(":leave", [useAnimation(hideOverlayContentAnimation)])])] }
	});
};
(() => {
