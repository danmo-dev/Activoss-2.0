import { Dl as ɵɵdefineInjector, En as ElementRef, Er as ViewContainerRef, Fc as NgZone, In as Input, Lc as PLATFORM_ID, O as booleanAttribute, Pn as Inject, Wi as setClassMetadata, ir as Renderer2, la as ɵɵNgOnChangesFeature, no as ɵɵdefineDirective, oo as ɵɵdirectiveInject, qn as NgModule, ro as ɵɵdefineNgModule, rt as numberAttribute, vr as TemplateRef, wn as Directive } from "./core-CK5_Em9Y.js";
import { C as CommonModule, u as isPlatformBrowser } from "./common-CVhezUSH.js";
import { n as DomHandler, t as ConnectedOverlayScrollHandler } from "./primeng-dom-QnWno1CE.js";
import { f as PrimeNGConfig, v as UniqueComponentId, y as zindexutils } from "./primeng-api-hFM0rYSV.js";
...
var Tooltip = class Tooltip {
	...
	*/
	...
	setAriaDescribedBy() {
		...
		if (tooltipId && this.active) this.renderer.setAttribute(this.el.nativeElement, "aria-describedby", tooltipId);
	}
	...
	onMouseLeave(e) {
		if (!this.isAutoHide()) !(DomHandler.hasClass(e.relatedTarget, "p-tooltip") || DomHandler.hasClass(e.relatedTarget, "p-tooltip-text") || DomHandler.hasClass(e.relatedTarget, "p-tooltip-arrow")) && this.deactivate();
		...
		switch (this.getOption("tooltipPosition")) {
			case "top":
				...
				if (this.isOutOfBounds()) {
					...
					if (this.isOutOfBounds()) {
						this.alignRight();
						if (this.isOutOfBounds()) this.alignLeft();
					}
				}
				break;
			case "bottom":
			...
			case "left":
				...
				if (this.isOutOfBounds()) {
					...
					if (this.isOutOfBounds()) {
						this.alignTop();
						if (this.isOutOfBounds()) this.alignBottom();
					}
				}
				break;
			case "right":
	...
	getHostOffset() {
		if (this.getOption("appendTo") === "body" || this.getOption("appendTo") === "target") {
			...
			return {
				left: offset.left + DomHandler.getWindowScrollLeft(),
				top: offset.top + DomHandler.getWindowScrollTop()
			};
		} else return {
			left: 0,
			top: 0
	...
	static ɵfac = function Tooltip_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Tooltip)(ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(PrimeNGConfig), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ViewContainerRef));
	};
