import { $n as Output, Dl as ɵɵdefineInjector, Do as ɵɵgetCurrentView, Dr as ViewEncapsulation, Ea as ɵɵcontentQuery, Fc as NgZone, Fl as ɵɵresetView, Gs as ɵɵtextInterpolate, Hs as ɵɵtemplate, Il as ɵɵrestoreView, In as Input, O as booleanAttribute, Oo as ɵɵgetInheritedFactory, Pl as ɵɵnamespaceSVG, Pn as Inject, S as ViewChild, Us as ɵɵtemplateRefExtractor, Wi as setClassMetadata, Ws as ɵɵtext, Xo as ɵɵloadQuery, Yo as ɵɵlistener, Zo as ɵɵnextContext, _o as ɵɵelementContainer, a as ContentChildren, an as ChangeDetectionStrategy, ba as ɵɵclassMap, bc as EventEmitter, bo as ɵɵelementEnd, bs as ɵɵreference, ca as ɵɵInheritDefinitionFeature, cn as Component, cs as ɵɵpureFunction1, da as ɵɵadvance, do as ɵɵdomElementEnd, ds as ɵɵpureFunction4, fo as ɵɵdomElementStart, go as ɵɵelement, ir as Renderer2, ls as ɵɵpureFunction2, mc as DOCUMENT, mo as ɵɵdomProperty, oo as ɵɵdirectiveInject, os as ɵɵproperty, qn as NgModule, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, rt as numberAttribute, sc as ɵɵviewQuery, so as ɵɵdomElement, to as ɵɵdefineComponent, vo as ɵɵelementContainerEnd, vs as ɵɵqueryRefresh, xo as ɵɵelementStart, ya as ɵɵattribute, yo as ɵɵelementContainerStart } from "./core-CK5_Em9Y.js";
...
import { _ as ObjectUtils, f as PrimeNGConfig, l as MessageService, m as SharedModule, p as PrimeTemplate, v as UniqueComponentId, y as zindexutils } from "./primeng-api-hFM0rYSV.js";
import { a as animateChild, d as transition, f as trigger, i as animate, l as state, s as query, u as style } from "./private_export-BY7Yl8vB.js";
...
//#endregion
//#region node_modules/primeng/fesm2022/primeng-toast.mjs
var _c0 = ["container"];
...
function ToastItem_ng_template_3_button_3_span_1_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "span");
	if (rf & 2) ɵɵclassMap("pt-1 text-base p-toast-message-icon pi " + ɵɵnextContext(3).message.closeIcon);
}
function ToastItem_ng_template_3_button_3_TimesIcon_2_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "TimesIcon", 16);
	if (rf & 2) {
...
function ToastItem_ng_template_3_button_3_Template(rf, ctx) {
	if (rf & 1) {
		...
		ɵɵlistener("click", function ToastItem_ng_template_3_button_3_Template_button_click_0_listener($event) {
			ɵɵrestoreView(_r2);
			return ɵɵresetView(ɵɵnextContext(2).onCloseIconClick($event));
...
var ToastItem = class ToastItem {
	...
	initTimeout() {
		if (!this.message?.sticky) this.zone.runOutsideAngular(() => {
	...
	static ɵfac = function ToastItem_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || ToastItem)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(PrimeNGConfig));
	};
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		type: ToastItem,
		...
		encapsulation: 2,
		data: { animation: [trigger("messageState", [
			state("visible", style({
			...
			transition("* => void", [animate("{{hideTransitionParams}}", style({
				height: 0,
				opacity: 0,
...
(() => {
	...
	}], () => [{ type: NgZone }, { type: PrimeNGConfig }], {
		message: [{ type: Input }],
		index: [{
			type: Input,
	...
	*/
	...
	ngOnInit() {
		...
		this.clearSubscription = this.messageService.clearObserver.subscribe((key) => {
			if (key) {
				if (this.key === key) this.messages = null;
	...
	add(messages) {
		...
		if (this.preventDuplicates) this.messagesArchieve = this.messagesArchieve ? [...this.messagesArchieve, ...messages] : [...messages];
		this.cd.markForCheck();
	}
	canAdd(message) {
		let allow = this.key === message.key;
		if (allow && this.preventOpenDuplicates) allow = !this.containsMessage(this.messages, message);
		if (allow && this.preventDuplicates) allow = !this.containsMessage(this.messagesArchieve, message);
		return allow;
	}
	...
	onAnimationStart(event) {
		if (event.fromState === "void") {
			...
			if (this.autoZIndex && this.containerViewChild?.nativeElement.style.zIndex === "") zindexutils.set("modal", this.containerViewChild?.nativeElement, this.baseZIndex || this.config.zIndex.modal);
		}
	}
	onAnimationEnd(event) {
		if (event.toState === "void") {
			if (this.autoZIndex && ObjectUtils.isEmpty(this.messages)) zindexutils.clear(this.containerViewChild?.nativeElement);
		}
	}
	createStyle() {
		if (!this.styleElement) {
			...
			for (let breakpoint in this.breakpoints) {
				let breakpointStyle = "";
				for (let styleProp in this.breakpoints[breakpoint]) breakpointStyle += styleProp + ":" + this.breakpoints[breakpoint][styleProp] + " !important;";
				innerHTML += `
	...
	ngOnDestroy() {
		...
		if (this.containerViewChild && this.autoZIndex) zindexutils.clear(this.containerViewChild.nativeElement);
		if (this.clearSubscription) this.clearSubscription.unsubscribe();
		this.destroyStyle();
	}
	static ɵfac = function Toast_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Toast)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(MessageService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PrimeNGConfig));
	};
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		type: Toast,
		selectors: [["p-toast"]],
		...
		encapsulation: 2,
		data: { animation: [trigger("toastAnimation", [transition(":enter, :leave", [query("@*", animateChild())])])] }
	});
};
(() => {
...
var ToastModule = class ToastModule {
