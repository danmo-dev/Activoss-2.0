import { $n as Output, Dr as ViewEncapsulation, Ea as ɵɵcontentQuery, En as ElementRef, Gs as ɵɵtextInterpolate, Hs as ɵɵtemplate, In as Input, O as booleanAttribute, Ol as ɵɵdefineInjector, Pn as Inject, Wi as setClassMetadata, Ws as ɵɵtext, Xo as ɵɵloadQuery, Yo as ɵɵlistener, Zo as ɵɵnextContext, _o as ɵɵelementContainer, a as ContentChildren, an as ChangeDetectionStrategy, as as ɵɵprojectionDef, ba as ɵɵclassMap, bo as ɵɵelementEnd, cn as Component, cs as ɵɵpureFunction1, da as ɵɵadvance, go as ɵɵelement, hc as DOCUMENT, is as ɵɵprojection, no as ɵɵdefineDirective, oo as ɵɵdirectiveInject, os as ɵɵproperty, qn as NgModule, ro as ɵɵdefineNgModule, rt as numberAttribute, to as ɵɵdefineComponent, vo as ɵɵelementContainerEnd, vs as ɵɵqueryRefresh, wn as Directive, xa as ɵɵclassProp, xc as EventEmitter, xo as ɵɵelementStart, ya as ɵɵattribute, yo as ɵɵelementContainerStart } from "./core-DAuPG1Te.js";
import { L as NgClass, V as NgIf, Z as NgTemplateOutlet, q as NgStyle } from "./common-BCt_Kb9Z.js";
import { n as DomHandler } from "./primeng-dom-QnWno1CE.js";
import { _ as ObjectUtils, m as SharedModule, p as PrimeTemplate } from "./primeng-api-BkqxM_dX.js";
import { t as AutoFocus } from "./primeng-autofocus-LNf3yPL9.js";
import { t as SpinnerIcon } from "./primeng-icons-spinner-cFEROwIM.js";
import { t as Ripple } from "./primeng-ripple-vPEEFmbA.js";
...
function Button_ng_container_3_ng_container_1_span_1_Template(rf, ctx) {
	...
	if (rf & 2) {
		ɵɵproperty("ngClass", ɵɵnextContext(3).iconClass());
...
function Button_ng_container_3_ng_container_1_SpinnerIcon_2_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "SpinnerIcon", 9);
	if (rf & 2) {
		ɵɵproperty("styleClass", ɵɵnextContext(3).spinnerIconClass())("spin", true);
		ɵɵattribute("aria-hidden", true)("data-pc-section", "loadingicon");
	}
}
...
function Button_ng_container_3_2_Template(rf, ctx) {
	if (rf & 1) ɵɵtemplate(0, Button_ng_container_3_2_ng_template_0_Template, 0, 0, "ng-template", 10);
	if (rf & 2) ɵɵproperty("ngIf", ɵɵnextContext(2).loadingIconTemplate);
}
...
function Button_ng_container_4_span_1_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "span", 8);
	if (rf & 2) {
		ɵɵproperty("ngClass", ɵɵnextContext(2).iconClass());
		ɵɵattribute("data-pc-section", "icon");
	}
}
function Button_ng_container_4_2_ng_template_0_Template(rf, ctx) {}
function Button_ng_container_4_2_Template(rf, ctx) {
	if (rf & 1) ɵɵtemplate(0, Button_ng_container_4_2_ng_template_0_Template, 0, 0, "ng-template", 10);
	if (rf & 2) {
		const ctx_r0 = ɵɵnextContext(2);
...
* @group Components
*/
var ButtonDirective = class ButtonDirective {
	el;
	document;
	/**
	...
	*/
	...
	getStyleClass() {
		...
		if (this.icon && !this.label && ObjectUtils.isEmpty(this.htmlElement.textContent)) styleClass.push(INTERNAL_BUTTON_CLASSES.iconOnly);
		if (this.loading) {
	...
	createLabel() {
		if (!DomHandler.findSingle(this.htmlElement, ".p-button-label") && this.label) {
			let labelElement = this.document.createElement("span");
			if (this.icon && !this.label) labelElement.setAttribute("aria-hidden", "true");
	...
	createIcon() {
		if (!DomHandler.findSingle(this.htmlElement, ".p-button-icon") && (this.icon || this.loading)) {
			let iconElement = this.document.createElement("span");
			iconElement.className = "p-button-icon";
			iconElement.setAttribute("aria-hidden", "true");
			let iconPosClass = this.label ? "p-button-icon-" + this.iconPos : null;
			if (iconPosClass) DomHandler.addClass(iconElement, iconPosClass);
			let iconClass = this.getIconClass();
			if (iconClass) DomHandler.addMultipleClasses(iconElement, iconClass);
	...
	updateIcon() {
		...
		let labelElement = DomHandler.findSingle(this.htmlElement, ".p-button-label");
		if (iconElement) if (this.iconPos) iconElement.className = "p-button-icon " + (labelElement ? "p-button-icon-" + this.iconPos : "") + " " + this.getIconClass();
	...
	static ɵfac = function ButtonDirective_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || ButtonDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
	};
...
var Button = class Button {
	...
	*/
	...
	iconClass() {
		...
		if (this.loading) iconClasses[`p-button-loading-icon pi-spin ${this.loadingIcon ?? ""}`] = true;
		else if (this.icon) iconClasses[this.icon] = true;
		return iconClasses;
	}
	get buttonClass() {
		return {
	...
	*/
	...
	static ɵfac = function Button_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || Button)(ɵɵdirectiveInject(ElementRef));
	};
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		hostBindings: function Button_HostBindings(rf, ctx) {
			if (rf & 2) ɵɵclassProp("p-disabled", ctx.disabled);
		},
		inputs: {
			type: "type",
			iconPos: "iconPos",
...
var ButtonModule = class ButtonModule {
	...
	static ɵinj = /* @__PURE__ */ ɵɵdefineInjector({ imports: [Button, SharedModule] });
};
(() => {
