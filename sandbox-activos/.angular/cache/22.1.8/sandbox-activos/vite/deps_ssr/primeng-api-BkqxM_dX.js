import { Dl as ɵɵdefineInjectable, Fn as Injectable, In as Input, Ol as ɵɵdefineInjector, Rl as require_cjs, Sl as signal, Wi as setClassMetadata, as as ɵɵprojectionDef, cn as Component, is as ɵɵprojection, no as ɵɵdefineDirective, oo as ɵɵdirectiveInject, qn as NgModule, ro as ɵɵdefineNgModule, to as ɵɵdefineComponent, vr as TemplateRef, wn as Directive } from "./core-DAuPG1Te.js";
//#region node_modules/primeng/fesm2022/primeng-utils.mjs
var import_cjs = require_cjs();
var ObjectUtils = class ObjectUtils {
	...
	static resolveFieldData(data, field) {
		if (data && field) if (this.isFunction(field)) return field(data);
	...
	static insertIntoOrderedArray(item, index, arr, sourceArr) {
		if (arr.length > 0) {
			let injected = false;
			for (let i = 0; i < arr.length; i++) if (this.findIndexInList(arr[i], sourceArr) > index) {
				arr.splice(i, 0, item);
				injected = true;
				break;
			}
	...
	static findIndexInList(item, list) {
		let index = -1;
		if (list) {
			for (let i = 0; i < list.length; i++) if (list[i] == item) {
				index = i;
				break;
			}
		}
	...
	static contains(value, list) {
		if (value != null && list && list.length) {
			for (let val of list) if (this.equals(value, val)) return true;
		}
		return false;
	}
	static removeAccents(str) {
		if (str) str = str.normalize("NFKD").replace(/\p{Diacritic}/gu, "");
		return str;
	}
	static isDate(input) {
	...
	static sort(value1, value2, order = 1, locale, nullSortOrder = 1) {
		...
		if (ObjectUtils.isEmpty(value1) || ObjectUtils.isEmpty(value2)) finalSortOrder = nullSortOrder === 1 ? order : nullSortOrder;
		return finalSortOrder * result;
	}
	static merge(obj1, obj2) {
		if (obj1 == void 0 && obj2 == void 0) return;
		else if ((obj1 == void 0 || typeof obj1 === "object") && (obj2 == void 0 || typeof obj2 === "object")) return {
			...obj1 || {},
			...obj2 || {}
		};
		else if ((obj1 == void 0 || typeof obj1 === "string") && (obj2 == void 0 || typeof obj2 === "string")) return [obj1 || "", obj2 || ""].join(" ");
		return obj2 || obj1;
	}
...
var FilterService = class FilterService {
	...
	filters = {
		...
		in: (value, filter) => {
			...
			for (let i = 0; i < filter.length; i++) if (ObjectUtils.equals(value, filter[i])) return true;
			return false;
		},
...
var PrimeNGConfig = class PrimeNGConfig {
	ripple = false;
	inputStyle = signal("outlined");
	overlayOptions = {};
	csp = signal({ nonce: void 0 });
...
//#endregion
export { ObjectUtils as _, FilterOperator as a, Header as c, PrimeIcons as d, PrimeNGConfig as f, TreeDragDropService as g, TranslationKeys as h, FilterMatchMode as i, MessageService as l, SharedModule as m, ConfirmationService as n, FilterService as o, PrimeTemplate as p, ContextMenuService as r, Footer as s, ConfirmEventType as t, OverlayService as u, UniqueComponentId as v, zindexutils as y };
